...
import com.github.yyeerai.hybridserverapi.common.yaml.boostedyaml.engine.ExtendedRepresenter;
...
import com.github.yyeerai.hybridserverapi.common.yaml.boostedyaml.updater.Updater;
...
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.api.YamlUnicodeReader;
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.composer.Composer;
...
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.parser.ParserImpl;
...
public class YamlDocument extends Section {
    ...
    /**
     * 使用给定设置从给定流创建并初始加载 YAML 文档。默认值也将使用相同的设置加载。
     * <p> 给定的设置现在将与创建的文档和加载的默认值关联。
     * 由于您没有提供{@link File}，因此每次重新加载保存时都需要提供数据输入输出。
     *

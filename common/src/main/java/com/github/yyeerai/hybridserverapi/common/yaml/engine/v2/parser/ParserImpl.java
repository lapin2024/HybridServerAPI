 ...
 */
package com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.parser;
...
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.common.*;
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.events.*;
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.exceptions.Mark;
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.exceptions.ParserException;
...
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.scanner.Scanner;
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.scanner.ScannerImpl;
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.scanner.StreamReader;
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.tokens.*;
...
public class ParserImpl implements Parser {
            ...
            if (dirOption.isPresent()) {
                ...
                if (token.getName().equals(DirectiveToken.YAML_DIRECTIVE)) {
                    ...
                    yamlSpecVersion = Optional.of(
                            settings.getVersionFunction().apply(new SpecVersion(major, minor)));
    ...
    private Event parseNode(boolean block, boolean indentlessSequence) {
        ...
        if (scanner.checkToken(Token.ID.Alias)) {
            ...
            event = new AliasEvent(Optional.of(token.getValue()), token.getStartMark(),
                    token.getEndMark());
            ...
            if (indentlessSequence && scanner.checkToken(Token.ID.BlockEntry)) {
                ...
                if (scanner.checkToken(Token.ID.Scalar)) {
                    ...
                    event = new SequenceStartEvent(anchor, tag, implicit, FlowStyle.BLOCK, startMark,
                            endMark);
            ...
            if (!scanner.checkToken(Token.ID.FlowSequenceEnd)) {
                ...
                if (scanner.checkToken(Token.ID.Key)) {
                    ...
                    Event event = new MappingStartEvent(Optional.empty(), Optional.empty(), true,
                            FlowStyle.FLOW, token.getStartMark(),
                            token.getEndMark());

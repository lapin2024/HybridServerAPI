...
import com.github.yyeerai.hybridserverapi.common.yaml.boostedyaml.engine.ExtendedConstructor;
...
import com.github.yyeerai.hybridserverapi.common.yaml.boostedyaml.utils.conversion.ListConversions;
import com.github.yyeerai.hybridserverapi.common.yaml.boostedyaml.utils.conversion.PrimitiveConversions;
import com.github.yyeerai.hybridserverapi.common.yaml.engine.v2.nodes.MappingNode;
...
public class Section extends Block<Map<Object, Block<?>>> {
     ...
     * <p>
     * More formally, if key format is {@link GeneralSettings.KeyFormat#STRING STRING}, returns the result of {@link Object#toString()}
    ...
    public Object adaptKey(@NotNull Object key) {
        ...
        return root.getGeneralSettings().getKeyFormat() == GeneralSettings.KeyFormat.OBJECT ? key : key.toString();
    }
     ...
     * contains individual <b>string</b> keys, if set to {@link GeneralSettings.KeyFormat#OBJECT}, you will only be able to access data
    ...
    public <T> Optional<T> getAsOptional(@NotNull Route route, @NotNull Class<T> clazz) {
        return getOptional(route).map((object) -> clazz.isInstance(object) ? (T) object :
                PrimitiveConversions.isNumber(object.getClass()) && PrimitiveConversions.isNumber(clazz) ? (T) PrimitiveConversions.convertNumber(object, clazz) :
                        PrimitiveConversions.NON_NUMERIC_CONVERSIONS.containsKey(object.getClass()) && PrimitiveConversions.NON_NUMERIC_CONVERSIONS.containsKey(clazz) ? (T) object : null);
    }
    ...
    public Optional<List<String>> getOptionalStringList(@NotNull Route route) {
        return ListConversions.toStringList(getList(route, null));
    }
    ...
    public Optional<List<Integer>> getOptionalIntList(@NotNull Route route) {
        return ListConversions.toIntList(getList(route, null));
    }
    ...
    public Optional<List<BigInteger>> getOptionalBigIntList(@NotNull Route route) {
        return ListConversions.toBigIntList(getList(route, null));
    }
    ...
    public Optional<List<Byte>> getOptionalByteList(@NotNull Route route) {
        return ListConversions.toByteList(getList(route, null));
    }
    ...
    public Optional<List<Long>> getOptionalLongList(@NotNull Route route) {
        return ListConversions.toLongList(getList(route, null));
    }
    ...
    public Optional<List<Double>> getOptionalDoubleList(@NotNull Route route) {
        return ListConversions.toDoubleList(getList(route, null));
    }
    ...
    public Optional<List<Float>> getOptionalFloatList(@NotNull Route route) {
        return ListConversions.toFloatList(getList(route, null));
    }
    ...
    public Optional<List<Short>> getOptionalShortList(@NotNull Route route) {
        return ListConversions.toShortList(getList(route, null));
    }
    ...
    public Optional<List<Map<?, ?>>> getOptionalMapList(@NotNull Route route) {
        return ListConversions.toMapList(getList(route, null));
    }

package com.github.yyeerai.hybridserverapi.common.core.exceptions;

import com.github.yyeerai.hybridserverapi.common.core.lang.func.*;
 ...
 * <p>
 * 该工具通过函数式的方式将那些需要抛出受检查异常的表达式或者代码段转化成一个 func.lang.core.com.github.yyeerai.hybridserverapi.common.Func* 对象
 * </p>
 * <p>
 * {@code
 * <pre>
 ...
 *       // use describedObject ...
 *
 *       CheckedUtil.uncheck 方法接受任意可以转化成 func.lang.core.com.github.yyeerai.hybridserverapi.common.Func* 函数式接口的 Lambda 表达式。返回对应的函数式对象。
 *       上述代码可以理解为：
...
public class CheckedUtil {
    ...
    /**
     * 接收一个可以转化成 func.lang.core.com.github.yyeerai.hybridserverapi.common.Func 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
    ...
    /**
     * 接收一个可以转化成 func.lang.core.com.github.yyeerai.hybridserverapi.common.Func0 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
     * 如此一来，代码中就不用显示的try-catch转化成运行时异常
     *
    ...
    /**
     * 接收一个可以转化成 func.lang.core.com.github.yyeerai.hybridserverapi.common.Func1 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
     * 如此一来，代码中就不用显示的try-catch转化成运行时异常
     *
     * @param expression 运行时传入的参数类型
     * @param <P>        运行时传入的参数类型
    ...
    /**
     * 接收一个可以转化成 func.lang.core.com.github.yyeerai.hybridserverapi.common.VoidFunc 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
     * 如此一来，代码中就不用显示的try-catch转化成运行时异常
     *
     * @param expression 运行时传入的参数类型
     * @param <P>        运行时传入的参数类型
    ...
    /**
     * 接收一个可以转化成 func.lang.core.com.github.yyeerai.hybridserverapi.common.VoidFunc0 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
     * 如此一来，代码中就不用显示的try-catch转化成运行时异常
     *
     * @param expression 运行时传入的参数类型
    ...
    /**
     * 接收一个可以转化成 func.lang.core.com.github.yyeerai.hybridserverapi.common.VoidFunc1 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
     * 如此一来，代码中就不用显示的try-catch转化成运行时异常
     *
     * @param expression 运行时传入的参数类型
     * @param <P>        运行时传入的参数类型

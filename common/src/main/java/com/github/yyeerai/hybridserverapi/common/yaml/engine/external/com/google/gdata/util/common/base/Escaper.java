 ...
 */
package com.github.yyeerai.hybridserverapi.common.yaml.engine.external.com.google.gdata.util.common.base;
 ...
 * <p>
 * <p>
 * For example, an XML escape would convert the literal string {@code "Foo<Bar>"} into {@code
 * "Foo&lt;Bar&gt;"} to prevent {@code "<Bar>"} from being confused with an XML tag. When the
 * resulting XML document is parsed, the scanner API will return this text as the original literal
 * string {@code "Foo<Bar>"}.
 * <p>
 * <p>
 * An {@code Escape} instance is required to be stateless, and safe when used concurrently by
 * multiple threads.
 * <p>
 * <p>

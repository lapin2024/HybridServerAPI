...
public class ForgeEventListenerProcessor {
     ...
     */
    @Deprecated
    public static <E extends Event> void register(Object listener, EventBus eventBus) {
     ...
     * @param <E>      事件类型，必须继承自 Event
     */
    public static <E extends Event> void register(Plugin plugin, Object listener, EventBus eventBus) {
     ...
     */
    @NotNull
    private static <E extends Event> ForgeListener<E> createForgeListener(EventBus eventBus, Object listener, Method method) {
